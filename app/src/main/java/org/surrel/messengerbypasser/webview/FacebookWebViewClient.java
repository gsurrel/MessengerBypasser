...
public class FacebookWebViewClient extends WebViewClient {
    ...
    public void onReceivedError(WebView view, int errorCod, String description, String failingUrl) {
        Log.e(getClass().getSimpleName(), "This WebView has received an error while trying to load:");
        Log.e(getClass().getSimpleName(), "\tError code: " + errorCod);
        Log.e(getClass().getSimpleName(), "\tDescription: " + description);
        Log.e(getClass().getSimpleName(), "\tFailed URL: " + failingUrl);
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        Log.d(getClass().getSimpleName(), "shouldOverrideUrlLoading? " + url);

        // Do not override any type of loading if we can load any URL
        if (mAllowAnyUrl) {
            Log.d(getClass().getSimpleName(), "The user is allowing us to open any URL in this WebView, let it load.");
            return false;
        }

        // Avoid NPEs when clicking on weird blank links
        if (url.equals("about:blank")) {
            Log.d(getClass().getSimpleName(), "Blank page, let it load");
            return false;
        }
        ...
        Log.d(getClass().getSimpleName(), "Checking URL: " + url);
        Log.d(getClass().getSimpleName(), "\tDomain: " + domain);

        if (domain != null) {
            // Let this WebView open the URL
            // TODO: Check the proper domain names that facebook uses or find another way
            if (domain.contains("facebook.com/messages") || domain.contains("facebook.com/login")) {
                Log.d(getClass().getSimpleName(), "This URL should be loaded internally. Let it load.");
                view.loadUrl(url);
                return false;
            }
        }
        ...
        Log.d(getClass().getSimpleName(), "This URL should be loaded by a 3rd party. Override.");
