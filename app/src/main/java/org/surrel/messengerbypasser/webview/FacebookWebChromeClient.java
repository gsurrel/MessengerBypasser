...
package org.surrel.messengerbypasser.webview;
...
import org.surrel.messengerbypasser.R;

/**
 * Created by surrel on 27/06/2016.
 */
...
public class FacebookWebChromeClient extends WebChromeClient {
     ...
     *
     * @param allow {@link boolean} flag stating whether or not to allow this web application to see the device's location.
     */
...
//        return mVideoProgressView;
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        Log.d(getClass().getSimpleName(), "\tmessage: " + consoleMessage.message());
        Log.d(getClass().getSimpleName(), "\tlineNumber: " + consoleMessage.lineNumber());
        Log.d(getClass().getSimpleName(), "\tsourceID: " + consoleMessage.sourceId());
        return true;
    }
     ...
     *
     * @param uploadMsg A ValueCallback to set the URI of the file to upload. onReceiveValue must be called to wake up the
     *                  thread.
     */
     ...
     * @param uploadMsg  A ValueCallback to set the URI of the file to upload. onReceiveValue must be called to wake up the
     *                   thread.
     * @param acceptType The value of the 'accept' attribute of the input tag associated with this file picker.
     */
    @SuppressWarnings("unused")
     ...
     *                   thread.
     * @param acceptType The value of the 'accept' attribute of the input tag associated with this file picker.
     * @param capture    The value of the 'capture' attribute of the input tag associated with this file picker.
     */
     ...
     * Tell the client to open a file chooser.
     *
     * @param filePathCallback  {@link ValueCallback} used to set the list of URI(s) of the file(s) to upload. onReceiveValue must be
     *                          called to wake up the thread.
     * @param fileChooserParams {@link FileChooserParams} parameters used for the file chooser
