...
package org.surrel.messengerbypasser.activity;
...
import org.surrel.messengerbypasser.webview.FacebookWebChromeClient;
import org.surrel.messengerbypasser.webview.FacebookWebView;
import org.surrel.messengerbypasser.webview.FacebookWebViewClient;
...
public abstract class BaseFacebookWebViewActivity extends Activity implements
    ...
    // Constants
    private final static String LOG_TAG = "Base FB WebViewActivity";
...
//    }
    ...
    private void updateCacheMode() {
        if (checkNetworkConnection()) {
            Log.d(LOG_TAG, "Setting cache mode to: LOAD_DEFAULT");
            mWebSettings.setCacheMode(WebSettings.LOAD_DEFAULT);
        } else {
            Log.d(LOG_TAG, "Setting cache mode to: LOAD_CACHE_ONLY");
...
//        mLocationAlertDialog.show();
    ...
    public void onPageLoadStarted(String url) {
        Log.d(LOG_TAG, "onPageLoadStarted() -- url: " + url);
    ...
    public void onPageLoadFinished(String url) {
        Log.d(LOG_TAG, "onPageLoadFinished() -- url: " + url);
        //mProgressBar.setVisibility(View.GONE);
    }
    ...
    public void openExternalSite(String url) {
        Log.d(LOG_TAG, "openExternalSite() -- url: " + url);
